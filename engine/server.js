...
const INV_KO = {
  ...
  I7: { t: '사용자 입력이 SQL·HTML로 그대로 들어갑니다', c: '문자열로 쿼리를 조립하지 말고 파라미터라이즈드 쿼리를 쓰고, 출력은 인코딩하세요. DB 에러·스택은 클라이언트에 노출하지 마세요.' },
};
const SRC_KO = { I1: 'IDOR · 2계정', I2: 'BFLA · 권한', I3: '익명 접근', I4: '매스 어사인먼트', I5: '상태 전이', I6: '시크릿 노출', I7: '주입 · 실행 확인' };
